              ...
              children: [
                Container(
                  ...
                  child: const Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Closed Family Chat', style: TextStyle(color: Color(0xFFB7F1D7), fontWeight: FontWeight.w700)),
                      SizedBox(height: 12),
                      Text(
                        '가족끼리만 연결되는 채팅',
                      ...
                      SizedBox(height: 12),
                      Text(
                        'Flutter Web로 재구성된 가족 전용 채팅입니다. 관리자 초대 코드 기반으로만 입장할 수 있고, 가족 전체방과 DM만 운영됩니다.',
                ...
                GridView.count(
                  ...
                  childAspectRatio: columns == 1 ? 1.5 : 1.05,
                  children: [
                    _panel(
                      title: '저장된 프로필',
                    ...
                    _panel(
                      ...
                      child: Column(
                        children: [
                          TextField(controller: familyNameController, decoration: const InputDecoration(labelText: '가족 이름')),
                          const SizedBox(height: 12),
                          TextField(controller: adminNameController, decoration: const InputDecoration(labelText: '관리자 이름')),
                    ...
                    _panel(
                      ...
                      child: Column(
                        children: [
                          TextField(controller: inviteCodeController, decoration: const InputDecoration(labelText: '초대 코드')),
                          const SizedBox(height: 12),
                          TextField(controller: memberNameController, decoration: const InputDecoration(labelText: '이름')),
                          const SizedBox(height: 16),
                          SizedBox(
                            width: double.infinity,
